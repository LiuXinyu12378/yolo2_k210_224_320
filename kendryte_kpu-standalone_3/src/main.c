...
uint8_t g_ai_buf[320 * 225 * 3] __attribute__((
    aligned(16)));  //不知道什么原因这里必须大于224*224，太大了会闪屏

#define ANCHOR_NUM 5

float g_anchor[ANCHOR_NUM * 2] = {14.63, 31.82, 24.71, 54.4,  41.24,
                                  87.13, 64.9,  133.0, 98.93, 185.6};
...
int main(void) {
  ...
  detect_rl0.threshold = 0.4;
  detect_rl0.nms_value = 0.3;
  region_layer_init(&detect_rl0, 10, 7, 35, 320, 224);
